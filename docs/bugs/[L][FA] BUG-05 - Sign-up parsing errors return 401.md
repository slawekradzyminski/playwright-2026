...
Malformed sign-up JSON still returned 401 with Unauthorized. Valid registration remains available; retain Low for misleading request-error classification. Shared cause with BUG-01 is plausible but unverified.
