...
Rejected QR requests return JSON where error documentation advertises PNG. A caller can inspect the actual content type to obtain useful feedback; runtime rejection remains effective. Image-decoder failure is a possible consumer consequence, not a demonstrated outage.
