...
Recorded successful registrations persisted an unusable empty email, so the consequence extends beyond feedback to invalid account state. Recovery and verification failures remain untested possibilities. The later duplicate-email response blocked fresh reproduction rather than establishing a fix; no security compromise was demonstrated.
