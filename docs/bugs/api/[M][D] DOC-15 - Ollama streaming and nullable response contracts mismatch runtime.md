...
Normal SSE events and tool definitions contradict the declared array and nullable-value models, requiring custom parsing or model overrides for successful consumption. Hand-written clients complete the flow, but the published success representation is materially incompatible with the wire data. No production outage or bypass was demonstrated.
