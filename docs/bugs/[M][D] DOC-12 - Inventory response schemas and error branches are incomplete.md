...
**Severity:** Medium because the success contract excludes routine returned values. The error-only gaps have Low demonstrated impact and are grouped here without inflating the finding count.
