...
The unchanged live sign-up contract still omits documented error body models. A malformed request was reproduced, and the existing representative validation suite passes. Retain Low; the full original exploration matrix was not repeated.
