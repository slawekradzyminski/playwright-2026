...
Medium is retained because valid input under the published contract cannot complete registration, with a workaround that requires changing the password. The evidence does not show a general registration outage or a security compromise warranting High.
