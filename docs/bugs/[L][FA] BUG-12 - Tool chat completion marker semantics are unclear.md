...
`http://localhost:8081`; backend `slawekradzyminski/backend:3.7.16`; mock `slawekradzyminski/ollama-mock:1.0.9`; disposable ROLE_CLIENT, no MFA. Deployed source revision unverified. [Contract](../exploratory-testing/openapi-2026-09-11-8081.json).
...
**Low, provisional:** a reproducible integration ambiguity with a working EOF-based consumption path. Escalation requires an agreed terminal-marker requirement or evidence of an affected supported consumer.
