...
Cart add/update correctly reject insufficient stock and preserve both customers' carts, but the contract omits the 409 recovery branch. Integrators cannot derive this supported stock-conflict outcome from the declared operation. No stock corruption or successful-purchase failure is demonstrated; clients can add explicit 409 handling.
