...
- Status: Open
- Severity (proposed): Medium — generated API clients and consumers may parse normal validation and authentication failures as images, obscuring actionable error details.
