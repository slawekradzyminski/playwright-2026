...
A settled mobile toast overlaps secondary footer actions, but it has a visible close control and practical interaction blockage has not been established. The recorded effect is temporary visual obstruction, not persistent loss of registration access. Placement intent remains unresolved, so the report stays suspected.
