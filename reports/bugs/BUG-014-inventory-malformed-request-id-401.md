...
- Type: Functional
- Status: Suspected
- Severity (proposed): Medium; a valid administrator receives an authentication error for a request-body validation failure, obscuring the actionable input problem and making client retries/diagnostics unreliable.
