...
Opening the mobile menu near the footer partially obscures its heading and makes the visual boundary unclear. The record does not establish blocked interaction, and closing the menu exposes the underlying content. Whether this overlay is unintended remains unresolved.
