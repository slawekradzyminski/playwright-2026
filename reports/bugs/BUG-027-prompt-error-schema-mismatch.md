...
- Status: Open
- Severity (proposed): Medium — generated clients and contract assertions may deserialize authentication failures as prompt DTOs instead of the observed error object.
